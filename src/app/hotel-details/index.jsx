...
import PropertyViewCarousel from './property-view-carousal'
import HotelMetaDetails from './hotel-meta-details'
import HotelRoomsPicker from './hotel-room-picker'
...
const hotelInfo = HOTEL_INFO
  ...
  return (
       <div className='container mt-6 mb-12'>
        ...
        <aside className='w-[340px] p-4 shrink-0 border border-border shadow-md rounded-xl sticky top-6 h-min'>
        <HotelCheckoutCard />
        </aside>
        </div>
    </div>

  ...
  return (
    <div className="space-y-4 ">
      ...
      <Button
        ...
        className="w-full h-12 text-base font-semibold cursor-pointer rounded-lg text-white shadow-sm hover:shadow transition-all border border-blue-600/20 bg-linear-to-r from-blue-700 via-blue-600 to-sky-500 hover:from-blue-800 hover:via-blue-700 hover:to-sky-600"

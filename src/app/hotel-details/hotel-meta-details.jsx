...
export const HotelDetailsHeader = ({ hotel }) => (
  <section className="space-y-4">
    ...
    <div className="text-orange-500 bg-orange-50 flex gap-1 p-2 items-start border rounded-sm">
      <Icon icon="heart" size="16" className="shrink-0 mt-0.5" />
      <p className="text-sm font-medium leading-snug">
        Located Less Than 5 Km From Medanta Hospital | Located 3 Kms From Omaxe
        Celebration Mall
      </p>
    </div>
  </section>
...
export const HotelAmenitiesSection = ({ hotel }) => (
  <section className="space-y-4 my-8">
    <h2 className="text-xl font-bold">Amenities</h2>
    <ul className="flex flex-wrap gap-2">
      {hotel.amenities.map((item, index) => (
        <li key={index} className="flex gap-2 items-center min-w-[180px] max-md:min-w-0 max-md:flex-1 max-md:basis-[calc(50%-0.25rem)]">
          <Icon icon="check" size="18" className="text-green-600 shrink-0" />
...
export const HotelAboutSection = ({ info }) => (
  <section className="space-y-4 my-8">

...
const EditProfile = () => {
  const { form, updateProfileHandler, pending, user } = useProfileForm();
    ...
    <Form {...form}>
      ...
      >
        <div className="flex justify-center sm:justify-start">
          <ProfileAvatarEditor user={user} size="md" />
        </div>
        <FormField
        ...
        <FormItem className="flex-1">
          <FormLabel className="inline-flex items-center gap-2">
            Email
            <span className="text-[10px] text-primary bg-blue-100 px-2 py-1 rounded-full">
              Not Editable
            </span>
          </FormLabel>
          <FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex-1">
              ...
              <FormControl>
                <InputDOB {...field} value={field.value ?? ''} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}

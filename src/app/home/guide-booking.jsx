 ...
 export default function HowItWorks() { 
   const steps = [ 
     { 
       ...
       description: "Pick the perfect place for your next staycation or getaway.", 
     ...
     { 
       title: "Select Dates", 
       description: "Set your check-in and check-out dates to plan your trip.", 
     ...
     { 
       title: "Add Guests & Search", 
       description: "Choose rooms and guests, then discover stays made for you.", 
       lottieData: lottiePulse(RGB.blueLight), 
       iconBg: `linear-gradient(135deg, ${BRAND.blue} 0%, #2563EB 100%)`, 
       iconColor: BRAND.white, 
       Icon: Users, 
         ...
         > 
           ...
           <div className="relative lg:col-span-6"> 
             ...
             > 
               ...
               {/* Step 1 — destination (top of journey) */} 
               <motion.div 
               ...
               {/* Floating badges — top to bottom matches steps 1 → 3 */} 
               <FloatBadge className="left-2 top-[18%]" delay={0.3} duration={5}> 
                 <MapPinned size={14} style={{ color: BRAND.blue }} /> 
                 <span>Choose destination</span> 
               </FloatBadge> 
  
               <FloatBadge className="right-0 top-[42%]" delay={0.55} duration={4.8}> 
                 <CalendarRange size={14} style={{ color: BRAND.blue }} /> 
                 <span>Select dates</span> 
               </FloatBadge> 
  
               <FloatBadge className="-bottom-2 right-4" delay={0.2} duration={4.5}> 
                 <Users size={14} style={{ color: BRAND.blue }} /> 
                 <span>Guests & search</span> 
               </FloatBadge> 
